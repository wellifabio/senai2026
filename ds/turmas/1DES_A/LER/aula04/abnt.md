...
- Margens: 3 cm para as margens esquerda e superior, e 2 cm para as margens direita e inferior.
- Alinhamento: Justificado para o texto e centralizado para títulos sem numeração de camítulo.
- Numeração de páginas: No cabeçalho à direita, as páginas devem ser numeradas a partir da introdução, mas a numeração deve começar a aparecer a partir da primeira página do texto (introdução). As páginas anteriores (capa, folha de rosto, resumo, sumário) não devem ser numeradas.
...
4. Sumário
5. Introdução
6. Capítulos (Regras de negócios, Requisitos funcionais, Requisitos não funcionais, Wireframes)
7. Conclusão ou Resultados
8. Bibliografia