...
|Fluxograma|Tarefa|
|-|:-:|
|![Fluxograma01](./fluxograma01.png)|A partir do fluxograma ao lado desenvolva o programa em linguagem C ou portugol|
...
```
### Task 04
É preciso saber em quantas empresas o paciente já trabalhou em quantos anos em cada empresa, por isso desenvolva um algoritmo e um fluxograma que peça ao paciente que informe em quantas empresas já trabalhou, em seguida para cada empresa pergunte o tempo em anos ele trabalhou nesta empresa, ao final informe o tempo total de experiência do paciente:
- exemplo
```cmd
Em quantas empresas você já trabalhou? 4
Na 1ª empresa ficou quantos anos: 0
Na 2ª empresa ficou quantos anos: 2
Na 3ª empresa ficou quantos anos: 0
Na 4ª empresa ficou quantos anos: 5
Você possui 7 nos de experiência
```
### Task 05
Desenvolva um programa que pergunte os vícios do paciente, se fuma, bebe ou usa drogas, se não possuir vícios apresente como resposta a palavra "Apto", se possuir apenas um vício "Reavaliado", se possuir mais de um vício "Inápto". Escreva o algoritmo e o fluxograma.
...
|11|Acertou todos os critérios críticos e pelo menos 10 dos 11 desejáveis|95|
|10|Acertou todos os critérios críticos e pelo menos 8 dos 11 desejáveis|90|
|9|Acertou todos os critérios críticos e pelo menos 7 dos 11 desejáveis|85|
|8|Acertou todos os critérios críticos e pelo menos 6 dos 11 desejáveis|80|
|7|Acertou todos os critérios críticos e pelo menos 5 dos 11 desejáveis|75|
|6|Acertou todos os critérios críticos e pelo menos 4 dos 11 desejáveis|70|
|5|Acertou todos os critérios críticos e pelo menos 3 dos 11 desejáveis|65|
|4|Acertou todos os critérios críticos e pelo menos 2 dos 11 desejáveis|60|
|3|Acertou todos os critérios críticos e pelo menos 1 dos 11 desejáveis|55|
