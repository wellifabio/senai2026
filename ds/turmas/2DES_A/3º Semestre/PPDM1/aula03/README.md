...
## Projeto - Quiz (Grupos no máximo 3 alunos)
Em grupos com até 3 componentes (caso seja 4 faça dois Apps ou dois temas no mesmo App), crie um quiz com pelo menos 10 questões, vários botões de alternativas (3 a 4), complete as lacunas, opções de fala, ou outros recursos sobre um dos temas a seguir:
- Temas
    - Português
    - Matemática
    - Geografia
...
## Tipos de Build
- Arquivo .aia (Projeto) exportar o arquivo neste formato para enviar para os integrantes do grupo e posterioemente para o github para entregar ao professor.
...
## [Exemplo de quiz com tela certo e errado](./quiz.md)
...
- Apresentar o quiz ao professor da matéria escolhida como tema.
    - Pedir para o professor responder o quiz e anotar a pontuação final da primeira tentativa.
