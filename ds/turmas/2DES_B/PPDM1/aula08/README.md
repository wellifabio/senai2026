...
- Segundo desafio [Estilização e Mockups](https://github.com/wellifabio/flutter-estilo-mokup-json-2026.git): Carregar dados de arquivo de texto Mockup e estilização.
    - Teste este projeto
    - Estude os códigos do diretório **lib**
    - Apos testar com seu VsCode, feche o projeto e o VsCode
    - Faça a atividade proposta criando um novo app do Zero
