...
# Atividade 01
## Extração
- Fazer download da planilha **[venda_carros.xlsx](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/venda_carros.xlsx)**  e do arquivo **[fundo.png](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/ilustracoes/fundo.png?raw=true)**.
...
![Fundo](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/ilustracoes/fundo.png?raw=true)

## Print da planilha do Excel com os dados brutos
![Fonte de dados](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/ilustracoes/dados.png?raw=true)

## Criar um painel de visualização (DashBoard) semelhante ao da imagem a seguir:
![Dashboard](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/ilustracoes/dashboard.png?raw=true)
OBS: Parque o gráfico de Mapas funcione, será necessário **habilitar a exibição de mapas**

## Atividade 02
- Faça a análise dos dados contidos no arquivo **[concessionaria.csv](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/concessionaria.csv)**
...
- ![Objetivo do exercício](https://github.com/wellifabio/senai2024/blob/main/power_bi_20/aula02/ilustracoes/execicio.png?raw=true)
